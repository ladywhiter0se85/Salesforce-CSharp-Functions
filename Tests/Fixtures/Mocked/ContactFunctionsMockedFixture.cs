namespace Tests.Fixtures
{
    public interface IContactFunctions
    {
        ...
        Task<HttpResponseData> PostContacts([HttpTrigger(AuthorizationLevel.Function, "post", Route = "contacts")] HttpRequestData req);
        Task<HttpResponseData> PatchContacts([HttpTrigger(AuthorizationLevel.Function, "patch", Route = "contacts")] HttpRequestData req);
        Task<HttpResponseData> PutContacts([HttpTrigger(AuthorizationLevel.Function, "put", Route = "contacts/external/{externalField}")] HttpRequestData req, string externalField);
    }
